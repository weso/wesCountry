...
java -Xms128m -Xmx512m -jar ./minify/compiler.jar --js ./bin/wesCountry.js --js_output_file ./bin/wesCountry.min.js --language_in ECMASCRIPT5
java -Xms128m -Xmx512m -jar ./minify/yuicompressor-2.4.8.jar ./bin/wesCountry.css -o ./bin/wesCountry.min.css
